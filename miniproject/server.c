...
#include <crypt.h> // Import for `crypt` function

#include "./function/server-constants.h"
#include "admins.h"
//include "./function/customer.h"
//#include "./function/manager.h"
//#include "./function/bankemployee.h"
//#include "./function/admin_operations.h" // Include the header
...
void connection_handler(int connectionFileDescriptor)
{
    ...
    else
    {
	    ...
	    case 3:
		//Bank Employee
		//Bankemployee_operation_handler(connectionFileDescriptor);
                 break;
            case 4:
		//Manager
